...
(()=>{
    var e = {
                    ...
                    return new Promise((t=>{
                        const n = new IntersectionObserver((([r])=>{
                            ...
                            t({
                                ...
                                size: {
                                    width: Math.ceil("auto" !== i.width ? parseFloat(i.width) : r.boundingClientRect.width),
                                    height: Math.ceil("auto" !== i.height ? parseFloat(i.height) : r.boundingClientRect.height)
                                }
                            }),
                            n.disconnect()
                        }
        ...
        307: (e,t)=>{
            ...
            var r;
            t.SDKError = n,
            (r = t.INIT_STATE || (t.INIT_STATE = {}))[r.UNINITIALIZED = 0] = "UNINITIALIZED",
                ...
                async init(e) {
                    return this.initializingPromise || (this.initializingPromise = new Promise((async(t,n)=>{
                        ...
                        if (i)
                            ...
                            const i = await (0,
                            h.prepareInitialGameData)(r, t);
                            this.sdk = new p.default(t,i,r);
                            try {
                                await (0,
                                u.loadAdsIfNeeded)(t.rafvertizingUrl, this.sdk)
                            } catch (e) {
                                (0,
                                d.sendErrorToGf)("ads-script-load-fail", "ad", {
                                    error: (0,
                                    a.stringifyError)(e)
                                }),
        ...
        492: function(e, t, n) {
            ...
            t.default = class {
                ...
                async renderFakeAd(e) {
                    return this.logger.log(`Requesting defused ${e} ad`),
        ...
        918: function(e, t, n) {
            ...
            function() {
                ...
                var fn = Wt({
                  ...
                  , gn = function e(t) {
                    var n, r = (t = null == t ? ht : gn.defaults(ht.Object(), t, gn.pick(ht, nt))).Array, ie = t.Date, be = t.Error, ke = t.Function, Ie = t.Math, Ee = t.Object, Se = t.RegExp, Ae = t.String, Me = t.TypeError, Te = r.prototype, De = ke.prototype, Re = Ee.prototype, Pe = t["__core-js_shared__"], Oe = De.toString, xe = Re.hasOwnProperty, Le = 0, Ce = (n = /[^.]+$/.exec(Pe && Pe.keys && Pe.keys.IE_PROTO || "")) ? "Symbol(src)_1." + n : "", Be = Re.toString, Ue = Oe.call(Ee), je = ht._, Ge = Se("^" + Oe.call(xe).replace(te, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Ne = gt ? t.Buffer : i, qe = t.Symbol, ze = t.Uint8Array, Fe = Ne ? Ne.allocUnsafe : i, We = sn(Ee.getPrototypeOf, Ee), Ve = Ee.create, $e = Re.propertyIsEnumerable, Je = Te.splice, Qe = qe ? qe.isConcatSpreadable : i, He = qe ? qe.iterator : i, Ke = qe ? qe.toStringTag : i, et = function() {
                        try {
                            var e = uo(Ee, "defineProperty");
                            return e({}, "", {}),
                            e
                        } catch (e) {}
                    }(), st = t.clearTimeout !== ht.clearTimeout && t.clearTimeout, lt = ie && ie.now !== ht.Date.now && ie.now, ct = t.setTimeout !== ht.setTimeout && t.setTimeout, dt = Ie.ceil, ft = Ie.floor, pt = Ee.getOwnPropertySymbols, vt = Ne ? Ne.isBuffer : i, Bt = t.isFinite, Wt = Te.join, pn = sn(Ee.keys, Ee), vn = Ie.max, yn = Ie.min, _n = ie.now, mn = t.parseInt, wn = Ie.random, bn = Te.reverse, kn = uo(t, "DataView"), In = uo(t, "Map"), En = uo(t, "Promise"), Sn = uo(t, "Set"), An = uo(t, "WeakMap"), Mn = uo(Ee, "create"), Tn = An && new An, Dn = {}, Rn = Uo(kn), Pn = Uo(In), On = Uo(En), xn = Uo(Sn), Ln = Uo(An), Cn = qe ? qe.prototype : i, Bn = Cn ? Cn.valueOf : i, Un = Cn ? Cn.toString : i;
                    function jn(e) {
                    ...
                    function Qn(e, t) {
                        var n = Fs(e)
                          ...
                          , u = a.length;
                        for (var l in e)
                            !t && !xe.call(e, l) || s && ("length" == l || i && ("offset" == l || "parent" == l) || o && ("buffer" == l || "byteLength" == l || "byteOffset" == l) || vo(l, u)) || a.push(l);
                        return a
                    }
                    function Hn(e) {
                        var t = e.length;
                    ...
                    function Yn(e, t, n) {
                        var r = e[t];
                        xe.call(e, t) && Gs(r, n) && (n !== i || t in e) || rr(e, t, n)
                    }
                    function er(e, t) {
                    ...
                    function sr(e, t, n, r, o, s) {
                        ...
                        if (h) {
                            if (a = function(e) {
                                ...
                                return t && "string" == typeof e[0] && xe.call(e, "index") && (n.index = e.index,
                                n.input = e.input),
                                n
                            }(e),
                            !u)
                    ...
                    function Mr(e, t, n) {
                        for (var o = n ? Rt : Dt, s = e[0].length, a = e.length, u = a, l = r(a), c = 1 / 0, h = []; u--; ) {
                            var d = e[u];
                            u && t && (d = Pt(d, Ht(t))),
                            c = yn(d.length, c),
                    ...
                    function Or(e) {
                        return !(!Ys(e) || (t = e,
                        Ce && Ce in t)) && (Xs(e) ? Ge : pe).test(Uo(e));
                        var t
                    }
                    function xr(e) {
                    ...
                    function jr(e, t) {
                        return _o(e) && ko(t) ? Io(Bo(e), t) : function(n) {
                            var r = Sa(n, e);
                            return r === i && r === t ? Aa(n, e) : Rr(t, r, 3)
                        }
                    }
                                    ...
                                    if (c)
                                        ...
                                        if (d) {
                                            var f = Fs(l)
                                              ...
                                              , p = !f && !g && ua(l);
                                            h = l,
                                            f || g || p ? Fs(u) ? h = u : $s(u) ? h = Ai(u) : g ? (d = !1,
                                            h = wi(l, !0)) : p ? (d = !1,
                    ...
                    function Hi(e, t, n, r) {
                        return e === i || Gs(e, Re[n]) && !xe.call(r, n) ? t : e
                    }
                    ...
                    : au;
                    function ro(e) {
                        for (var t = e.name + "", n = Dn[t], r = xe.call(Dn, t) ? n.length : 0; r--; ) {
                            var i = n[r]
                              , o = i.func;
                            if (null == o || o == e)
                                return i.name
                    ...
                    function yo(e, t, n) {
                        if (!Ys(n))
                            return !1;
                        var r = typeof t;
                        return !!("number" == r ? Vs(n) && vo(t, n.length) : "string" == r && t in n) && Gs(n[t], e)
                    }
                    function _o(e, t) {
                        if (Fs(e))
                            return !1;
                    ...
                    (kn && ho(new kn(new ArrayBuffer(1))) != O || In && ho(new In) != k || En && ho(En.resolve()) != S || Sn && ho(new Sn) != M || An && ho(new An) != R) && (ho = function(e) {
                        var t = Ir(e)
                    ...
                    var Go = Jr((function(e, t) {
                        return $s(e) ? lr(e, pr(t, 1, $s, !0)) : []
                    }
                    ))
                      , No = Jr((function(e, t) {
                        var n = Ho(t);
                        return $s(n) && (n = i),
                        $s(e) ? lr(e, pr(t, 1, $s, !0), oo(n, 2)) : []
                    }
                    ))
                      , qo = Jr((function(e, t) {
                        var n = Ho(t);
                        return $s(n) && (n = i),
                        $s(e) ? lr(e, pr(t, 1, $s, !0), i, n) : []
                    }
                    ));
                    function zo(e, t, n) {
                    ...
                    var es = Jr((function(e) {
                        return ai(pr(e, 1, $s, !0))
                    }
                    ))
                      , ts = Jr((function(e) {
                        var t = Ho(e);
                        return $s(t) && (t = i),
                        ai(pr(e, 1, $s, !0), oo(t, 2))
                    }
                    ))
                      , ns = Jr((function(e) {
                        var t = Ho(e);
                    ...
                    function xs(e, t) {
                        ...
                        return n.cache = new (xs.Cache || Vn),
                        n
                    }
                    function Ls(e) {
                        if ("function" != typeof e)
                    ...
                    function aa(e) {
                        return "symbol" == typeof e || ea(e) && Ir(e) == D
                    }
                      ...
                      , Ia = Jr((function(e, t) {
                        ...
                        for (o && yo(t[0], t[1], o) && (r = 1); ++n < r; )
                            for (var s = t[n], a = Pa(s), u = -1, l = a.length; ++u < l; ) {
                                var c = a[u]
                                  , h = e[c];
                                (h === i || Gs(h, Re[c]) && !xe.call(e, c)) && (e[c] = s[c])
                            }
                        return e
                    }
                    ))
                    ...
                    var Ma = ji((function(e, t, n) {
                      ...
                      , Da = Jr(Tr);
                    function Ra(e) {
                        return Vs(e) ? Qn(e) : Lr(e)
                    }
                    function Pa(e) {
                        return Vs(e) ? Qn(e, !0) : function(e) {
                            if (!Ys(e))
                                return function(e) {
                                    var t = [];
                                    if (null != e)
                            ...
                            var t = bo(e)
                              , n = [];
                            for (var r in e)
                                ("constructor" != r || !t && xe.call(e, r)) && n.push(r);
                            return n
                        }(e)
                    }
                    ...
                    ), 0), _u = Vi("ceil"), mu = Gi((function(e, t) {
                        return e / t
                    }
                    ), 1), wu = Vi("floor"), bu = Gi((function(e, t) {
                        return e * t
                    }
                    ), 1), ku = Vi("round"), Iu = Gi((function(e, t) {
                        return e - t
                    }
                    ), 0);
                    ...
                    jn.escape = function(e) {
                        return (e = ya(e)) && Q.test(e) ? e.replace($, tn) : e
                    }
                    ,
                    ...
                    jn.isEmpty = function(e) {
                        if (null == e)
                            return !0;
                        if (Vs(e) && (Fs(e) || "string" == typeof e || "function" == typeof e.splice || Js(e) || ua(e) || zs(e)))
                            return !e.length;
                        var t = ho(e);
                        if (t == k || t == M)
                            return !e.size;
                    ...
                    jn.subtract = Iu,
                    jn.sum = function(e) {
                        return e && e.length ? $t(e, nu) : 0
                    }
                    ,
                    jn.sumBy = function(e, t) {
                        return e && e.length ? $t(e, oo(t, 2)) : 0
                    }
                    ,
                    jn.template = function(e, t, n) {
                        ...
                        e = ya(e),
                        t = wa({}, t, r, Hi);
                        var o, s, a = wa({}, t.imports, r.imports, Hi), u = Ra(a), l = Xt(a, u), c = 0, h = t.interpolate || me, d = "__p += '", f = Se((t.escape || me).source + "|" + h.source + "|" + (h === Z ? he : me).source + "|" + (t.evaluate || me).source + "|$", "g"), g = "//# sourceURL=" + (xe.call(t, "sourceURL") ? (t.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++rt + "]") + "\n";
                    ...
                    jn.unescape = function(e) {
                        return (e = ya(e)) && J.test(e) ? e.replace(V, fn) : e
                    }
                    ,
        ...
        940: function(e, t, n) {
            ...
            t.renderFakeBanner = function(e) {
                ...
                if (e.isResponsive) {
                    const e = (0,
                    s.shuffle)(u).find((e=>n >= e.width && r >= e.height));
                    if (!e)
        ...
        951: function(e, t, n) {
            ...
            t.checkDataLimits = function(e) {
                ...
                t.length > .9 * i.MAX_DATA_LENGTH && h.warn(`You are approaching ${i.MAX_DATA_LENGTH} bytes data limit.`)
            }
            ,
