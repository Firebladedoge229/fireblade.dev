...
const SDK_INTERFACE_SETTINGS = {
  isProd: false, // crazygames v2 checks on production itself
  debugLevel: 1,
  ...
  interstitial: {
    ...
    preload: 0, // preload interval in ms
    retry: 0, // timeout before retry after preload fail
    timout: 0, // timout before calling showRewarded()
